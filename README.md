# Анализ оттока клиентов банка «Метанпромбанка»
...
- были выделены и приоритизированы сегменты, в наибольшей степени подверженных оттоку (от 21 до 30% отточных клиентов);
